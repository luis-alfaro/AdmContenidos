<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ReporteUsuariosCanalRipleymático.aspx.vb" Inherits="aspx_modificarLuego" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHContenido" Runat="Server">
    ...
    <body>
        <table style="width:100%;" bgcolor="#FFFFFF">
            ...
            <tr>
                <td bgcolor="#000000" style="height: 45px"></td>
            </tr>
            <tr>
                <td>
                    <table border="0" bgcolor="#FFFFFF" style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana; width: 747px; height: 110px;"  >
                        ...
                        <tr>
                            <td>Desde:</td>
                            <td><asp:TextBox  ID="txtfechadesde" runat="server" data-entryType="Date"></asp:TextBox></td>
                            <td>Hasta:</td>
                            <td><asp:TextBox ID="txtfechahasta" runat="server" data-entryType="Date"></asp:TextBox></td>
                            <td>Tipo Reporte:</td>
                            <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="scrolling" runat="server" id="divPrint">
                                                ...
                                                <br/><br />
                                                <asp:Panel ID="Panel1" runat="server" ScrollBars="auto" Width="1100px" Height="150px">                                                 
                                            ...
                                            <br/><br />
                                            <div class="scrolling">    
                                                <asp:Panel ID="Panel2" runat="server" ScrollBars="auto" Width="1100px" Height="150px">
                                                    <asp:GridView ID="grdClasicaChip" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" Font-Size="Small">
                                                        <RowStyle BackColor="#F7F7DE" />
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Acciones" Visible="False">
                                                                <ItemTemplate>
                                                ...
                                                <asp:Button ID="btnClasicaChip" runat="server" Text="Exportar a Excel" CssClass="button" />
                                            </div>
                                            <br/><br />
                                            <div class="scrolling">   
                                                <asp:Panel ID="Panel3" runat="server" ScrollBars="auto" Width="1100px" Height="150px"> 
                                            ...
                                            <br/><br/>
                                            <div class="scrolling">
                                                <asp:Panel ID="Panel4" runat="server" ScrollBars="auto" Width="1100px" Height="150px"> 
                                            ...
                                            <br/><br/>
                                            <div class="scrolling">
                                                <asp:Panel ID="Panel5" runat="server" ScrollBars="auto" Width="1100px" Height="150px">
                                            ...
                                            <br/><br/>
                                            <div class="scrolling">
                                                <asp:Panel ID="Panel6" runat="server" ScrollBars="auto" Width="1100px" Height="150px">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            ...
                                            <div class="scroll">
                                                ...
                                                <br/><br />
                                                <asp:Panel ID="Panel7" runat="server" ScrollBars="auto" Width="1100px" Height="150px">
                                            ...
                                            <br/><br/>
                                            <div class="scroll">    
                                                <asp:Panel ID="Panel8" runat="server" ScrollBars="auto" Width="1100px" Height="150px">
                                            ...
                                            <br/><br/>
                                            <div class="scroll">
                                                <asp:Panel ID="Panel9" runat="server" ScrollBars="auto" Width="1100px" Height="150px">
                                            ...
                                            <br/><br/>
                                            <div class="scroll">
                                                <asp:Panel ID="Panel10" runat="server" ScrollBars="auto" Width="1100px" Height="150px">
                                            ...
                                            <br/><br/>
                                            <div class="scroll">
                                                <asp:Panel ID="Panel11" runat="server" ScrollBars="auto" Width="1100px" Height="150px">
                                            ...
                                            <br/><br/>
                                            <div class="scroll">
                                                <asp:Panel ID="Panel12" runat="server" ScrollBars="auto" Width="1100px" Height="150px">
