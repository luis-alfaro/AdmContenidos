<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MantFlash.aspx.vb" Inherits="aspx_MantFlash" %>
    ...
    <table style="width: 100%; height: 951px;" style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana; width: 747px; height: 110px;"  >
        ...
        <tr>
            ...
            <td class="style35" colspan="2">
                ...
                <b><u>Actualización de Archivos Flash en el servidor</u></b></td>
                    </tr>
                </table>
                </b></td>
        </tr>
        ...
        <tr>
            <td class="style3" style="width: 52px; height: 13px;">
                &nbsp;</td>
            <td class="style53">
                <b>PASO 1:</b> Seleccionar Archivo Flash a subir</td>
            <td style="height: 13px">
        ...
        <tr>
            <td class="style29" style="width: 52px">
                &nbsp;</td>
            <td class="style30">
                <b>PASO 2:</b> Confirmar el Archivo Flash subido</td>
            <td class="style31">
                &nbsp;</td>
        </tr>
        <tr>
                ...
                <table style="width:100%;">
                    <tr>
                        <td class="style57">
                            &nbsp;</td>
                                <td>
                                    <b><u>Eliminación de Archivos Flash en el servidor</u></b></td>
                            </tr>
                        </table>
                        </b></td>
            <td class="style39">
        ...
        <tr>
            ...
            <td class="style38">
                <asp:Label ID="Label1" runat="server" 
                    Text="Lista de Archivos Flash en el servidor"></asp:Label>
            </td>
            <td class="style39">
                &nbsp;</td>
        </tr>
