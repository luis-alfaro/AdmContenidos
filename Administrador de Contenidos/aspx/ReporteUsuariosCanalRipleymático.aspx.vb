...
Partial Class aspx_modificarLuego
    ...
    Protected Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        cadena = "VistaImpresionUsuarios.aspx?tiporeporte=" & Me.ddltiporeporte.SelectedValue & "&tienda=" & Me.ddltiendas.SelectedValue & "&fechainicio=" & Me.txtfechadesde.Text & "&fechafin=" & Me.txtfechahasta.Text & "&Reporte=" & rep & "&Sucursal=" & Suc
        Response.Redirect("VistaImpresionUsuarios.aspx?tiporeporte=" & Me.ddltiporeporte.SelectedValue & "&tienda=" & Me.ddltiendas.SelectedValue & "&fechainicio=" & Me.txtfechadesde.Text & "&fechafin=" & Me.txtfechahasta.Text & "&Reporte=" & rep & "&Sucursal=" & Suc)
    End Sub
    ...
    Sub MostrarDatos()
        ...
        Try
            ...
            If Me.ddltiendas.SelectedValue = 0 And (idtienda = 0 Or idtienda = Nothing) And Me.ddltiporeporte.SelectedValue = 1 Then
                ...
                '/*GridView1--------------------------------------------------------------*/
                dts.Clear()
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "1", "1", Me.ddltiendas.SelectedValue, f1, f2)
                ...
                '/*grdClasicaChip--------------------------------------------------------------*/
                dts.Clear()
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "1", "7", Me.ddltiendas.SelectedValue, f1, f2)
                If dts.Tables("consulta").Rows.Count > 0 Then
                ...
                '/*GridView2--------------------------------------------------------------*/
                dts.Clear()
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "1", "2", Me.ddltiendas.SelectedValue, f1, f2)
                If dts.Tables("consulta").Rows.Count > 0 Then
                ...
                '/*GridView3--------------------------------------------------------------*/
                dts.Clear()
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "1", "3", Me.ddltiendas.SelectedValue, f1, f2)
                If dts.Tables("consulta").Rows.Count > 0 Then
                ...
                '/*GridView4--------------------------------------------------------------*/
                dts.Clear()
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "1", "4", Me.ddltiendas.SelectedValue, f1, f2)
                If dts.Tables("consulta").Rows.Count > 0 Then
                ...
                '/*GridView5--------------------------------------------------------------*/
                dts.Clear()
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "1", "5", Me.ddltiendas.SelectedValue, f1, f2)
                If dts.Tables("consulta").Rows.Count > 0 Then
            ...
            ElseIf Me.ddltiendas.SelectedValue = 0 And (idtienda = 0 Or idtienda = Nothing) And Me.ddltiporeporte.SelectedValue = 2 Then
                ...
                '/*GridView1--------------------------------------------------------------*/
                dts.Clear()
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "2", "1", Me.ddltiendas.SelectedValue, f1, f2)
                If dts.Tables("consulta").Rows.Count > 0 Then
                    existenRegistros0 = True
                    Me.GridView1.DataSource = dts : Me.GridView1.DataBind()
                Else
                ...
                dts.Clear()
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "2", "2", Me.ddltiendas.SelectedValue, f1, f2)
                If dts.Tables("consulta").Rows.Count > 0 Then
                    existenRegistros1 = True
                    Me.GridView2.DataSource = dts : Me.GridView2.DataBind()
                Else
                ...
                dts.Clear()
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "2", "3", Me.ddltiendas.SelectedValue, f1, f2)
                If dts.Tables("consulta").Rows.Count > 0 Then
                    existenRegistros2 = True
                    Me.GridView3.DataSource = dts : Me.GridView3.DataBind()
                Else
            ...
            If Me.ddltiporeporte.SelectedValue = 3 Then
                ...
                Else
                    entero = "1"
                End If
                dts = menus.sp_Reporte_Usuarios_Canal_Ripleymaticos("1", "3", "1", Me.ddltiendas.SelectedValue, f1, f2)
                If dts.Tables("consulta").Rows.Count > 0 Then
                    existenRegistros0 = True
                    Me.GridView1.DataSource = dts : Me.GridView1.DataBind()
                Else
    ...
    Public Sub exportarExcel(ByVal wControl As GridView)
        ...
        Response.AddHeader("content-disposition", "attachment;filename=ReporteUsuariosUnicos.xls")
        Response.Charset = ""
    ...
    Protected Sub btnClasicaChip_Click(sender As Object, e As EventArgs) Handles btnClasicaChip.Click
    ...
    Protected Sub btnClasicaChipDetalle_Click(sender As Object, e As EventArgs) Handles btnClasicaChipDetalle.Click
