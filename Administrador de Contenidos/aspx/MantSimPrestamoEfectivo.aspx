<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="MantSimPrestamoEfectivo.aspx.vb" Inherits="aspx_MantSimPrestamoEfectivo"
    Title="Mantenedor Simulador Préstamo Efectivo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="CPHContenido" runat="Server">
    <body topmargin="0" leftmargin="0" rightmargin="0" marginwidth="0" marginheight="0">
        <title>Administrador de Contenidos(Préstamo Efectivo) </title>
        ...
        <script type="text/javascript">
            ...
            function CrearTabla(tabla) {
                var c = ['IDPEF', 'Plazo Mínimo', 'Plazo Máximo', 'TEA', 'Monto Mínimo', 'Monto Máximo', 'FLAG', 'ACTUAL_VALUE'];
                var cm = [
            { name: 'IDPEF', index: 'IDPEF', width: 12, align: 'center', hidden: true, sortable: false },
            ...
            function dibujarTabla() {
                $.ajax({
                    type: "POST",
                    url: "MantSimPrestamoEfectivo.aspx/Obtener_SIM_PrestamoEfectivo",
                    data: null,
            ...
            function GuardarSimulador() {
                ...
                $.ajax({
                    type: "POST",
                    url: "MantSimPrestamoEfectivo.aspx/Guardar_SIM_PrestamoEfectivo",
                    data: dataVal,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    error: function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        <div style="margin-left: 10px; padding: 10px;">
            ...
            <tr>
                    <td colspan="2">
                        <h3>Simulador Préstamo Efectivo</h3>
                    </td>
                </tr>
            </table>
            <br />
