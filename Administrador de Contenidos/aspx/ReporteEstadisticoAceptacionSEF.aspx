...
CodeFile="ReporteEstadisticoAceptacionSEF.aspx.vb"  Inherits="aspx_ReporteEstadisticoAceptacionSEF" %>
...
//        $("input[data-entryType = 'Date']").datepicker();
        var arrayDialog = [{ name: dialogAlter, height: 140, width: 350, title: 'Reporte Estadístico Aceptación SEF'}];
        ...
        <tr>
            <td>
                <table border="0" bgcolor="#FFFFFF" style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana; width: 747px; height: 110px;"  >
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="7" style="text-align:center"><h2><b>GENERAR REPORTE ESTADÍSTICO DE DESEMBOLSO SEF</b></h2></td>
