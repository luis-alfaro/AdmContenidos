<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="MantTiempos.aspx.vb" Inherits="aspx_MantTiempos" title="Página sin título" %>
...
<td style="width: 484px; height: 218px">
    <table align="left" cellpadding="0" cellspacing="0" 
        ...
        style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana; width: 809px; height: 206px;">
            ...
            <tr>
                <td class="style9" style="width: 57px; height: 64px;">
                    </td>
                <td class="style9" style="width: 390px; height: 64px;">
                    <table style="width: 128%;">
                        <tr>
                            <td style="width: 234px">
                                <asp:Label ID="Label2" runat="server" 
                                    Text="Tiempo de Inactividad: "></asp:Label>
                                    <br />
                                    - Selección tipo tarjeta 
                                    <br />- Ingreso DNI <br /> - Ingreso 4 últimos dígitos
                            </td>
                            <td style="width: 27px">
                        ...
                        <tr>
                            <td style="width: 234px">
                                <asp:Label ID="Label1" runat="server" Text="Tiempo de Inactividad:"></asp:Label>
                                <br /> - Informativos <br /> - Consultas
                            </td>
                            <td style="width: 27px">
                        ...
                        <tr>
                            <td style="width: 234px">
                                <asp:Label ID="Label3" runat="server" 
                                    Text="Número de intentos fallidos en lectora (Nagios)"></asp:Label>
                            </td>
                            <td style="width: 27px">
                        ...
                        <tr>
                            <td style="width: 234px">
                                <asp:Label ID="Label6" runat="server" 
                                    Text="Tiempo de Inactividad - Comisiones"></asp:Label>
                            </td>
                            <td style="width: 27px">
                                <asp:TextBox ID="txtTiempoComisiones" runat="server" Width="34px" Height="22px" 
                                    Wrap="False"></asp:TextBox>
                            </td>
                            <td>
                                seg.</td>
