<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="MantSimReprogramaciones.aspx.vb" Inherits="aspx_MantSimReprogramaciones"
    Title="Mantenedor Simulador Reprogramaciones" %>

<asp:Content ID="Content1" ContentPlaceHolderID="CPHContenido" runat="Server">
    <body topmargin="0" leftmargin="0" rightmargin="0" marginwidth="0" marginheight="0">
        <title>Administrador de Contenidos(Reprogramaciones) </title>
        ...
        <script type="text/javascript">
            ...
            function CrearTabla(tabla) {
                var c = ['IDDREP', 'IDPREP', 'TIPO_TARJETA','Producto', 'Plazo Mínimo', 'Plazo Máximo', 'Envio EECC'
                        , 'Seguro Desgravamen', 'TEM', 'TEA', 'Membrecía', 'Comisión ATM', 'Monto Mínimo', 'Monto Máximo', 'FLAG', 'ACTUAL_VALUE'];
                var cm = [
            { name: 'IDDREP', index: 'IDDREP', width: 12, align: 'center', hidden: true, sortable: false },
            { name: 'IDPREP', index: 'IDPREP', width: 3, align: 'center', hidden: true, sortable: false },
            ...
            function dibujarTabla(idTarjeta) {
                ...
                $.ajax({
                    type: "POST",
                    url: "MantSimReprogramaciones.aspx/ObtenerReprogramaciones",
                    data: dataVal,
            ...
            function GuardarSimulador() {
                ...
                $.ajax({
                    type: "POST",
                    url: "MantSimReprogramaciones.aspx/GuardarReprogramaciones",
                    data: dataVal,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    error: function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        <div style="margin-left: 10px; padding: 10px;">
            ...
            <tr>
                    <td colspan="2">
                        <h3>Simulador de Reprogramaciones:</h3>
                    </td>
                </tr>
                <tr>
                    <td>
