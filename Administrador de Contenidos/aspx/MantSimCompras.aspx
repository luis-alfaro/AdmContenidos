<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="MantSimCompras.aspx.vb" Inherits="aspx_MantSimCompras"
    Title="Mantenedor Simulador Compras" %>
    ...
    <body topmargin="0" leftmargin="0" rightmargin="0" marginwidth="0" marginheight="0">
        ...
        <script type="text/javascript">
            ...
            function dibujarTabla(idTarjeta) {
                ...
                $.ajax({
                    type: "POST",
                    url: "MantSimCompras.aspx/Obtener_SIM_Compras",
                    data: dataVal,
            ...
            function GuardarSimulador() {
                ...
                $.ajax({
                    type: "POST",
                    url: "MantSimCompras.aspx/Guardar_SIM_Compras",
                    data: dataVal,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    error: function (XMLHttpRequest, textStatus, errorThrown) {
