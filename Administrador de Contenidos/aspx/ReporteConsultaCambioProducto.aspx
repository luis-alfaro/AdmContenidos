<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ReporteConsultaCambioProducto.aspx.vb" Inherits="aspx_ReporteConsultaCambioProducto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHContenido" Runat="Server">
    ...
    <body>
        <script type="text/javascript">
            ...
            function DocReady() {
                var arrayDialog = [{ name: dialogAlter, height: 140, width: 350, title: 'Reporte Consulta Cambio Producto'}];
                ...
                var ddltienda = '<%= ddltienda.ClientID %>';
                var txtNroContrato = '<%= txtNroContrato.ClientID %>';
            ...
            <tr>
                <td>
                    ...
                    <tr>
                        ...
                        <td colspan="7" style="text-align:center"><h2><b>CONSULTAR CAMBIO DE PRODUCTO</b></h2></td>
