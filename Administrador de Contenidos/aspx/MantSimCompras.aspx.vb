...
Partial Class aspx_MantSimCompras
    ...
    <WebMethod()>
    Public Shared Function Obtener_SIM_Compras(ByVal idTarjeta As Integer) As List(Of Simulador_Compras)
        Dim lista As New List(Of Simulador_Compras)
        Dim sim As New Simulador_Compras()
        Dim menus As New ClsReportes
        lista = menus.sp_get_Obtener_SIM_Compras(idTarjeta)
        Return lista
    End Function

    <WebMethod()>
    Public Shared Function Guardar_SIM_Compras(ByVal lista As List(Of Simulador_Compras)) As Integer
