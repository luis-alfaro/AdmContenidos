<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="MantSimEfectivoExpress.aspx.vb" Inherits="aspx_MantSimEfectivoExpress"
    Title="Mantenedor Simulador Efectivo Express" %>
    ...
    <body topmargin="0" leftmargin="0" rightmargin="0" marginwidth="0" marginheight="0">
        ...
        <script type="text/javascript">
            ...
            function CrearTabla(tabla) {
                var c = ['IDDEFE', 'IDPEFE', 'TIPO_TARJETA','Producto', 'Revolvente', 'Plazo Mínimo', 'Plazo Máximo', 'Envio EECC'
                        , 'Seguro Desgravamen', 'TEM', 'TEA', 'Membrecía', 'Comisión ATM', 'Monto Mínimo', 'Monto Máximo', 'FLAG', 'ACTUAL_VALUE'];
                var cm = [
            { name: 'IDDEFE', index: 'IDDEFE', width: 12, align: 'center', hidden: true, sortable: false },
            { name: 'IDPEFE', index: 'IDPEFE', width: 3, align: 'center', hidden: true, sortable: false },
            { name: 'TIPO_TARJETA', index: 'TIPO_TARJETA', width: 3, align: 'center', hidden: true, sortable: false },
            { name: 'PRODUCTO', index: 'PRODUCTO', width: 180, align: 'center', editable: true, sortable: false },
            { name: 'REVOLVENTE_TEXT', index: 'REVOLVENTE_TEXT', width: 95, align: 'center', sortable: false },
                ...
                tableToGrid(tabla, {
                    ...
                    afterSaveCell: function (rowid, cellname, value, iRow, iCol) {
                        if (cellname != "PRODUCTO") {
                            ...
                            if (row['REVOLVENTE_TEXT'] != "SI") {
                                var valor = parseFloat(row['PLAZO_MIN']);
                                if (valor == 0) {
                                    alert("El plazo mínimo no puede ser 0(cero)");
                                    row[cellname] = valorPrevio;
                                    jQuery("#" + tablaMantenimiento).jqGrid('setRowData', rowid, row);
                                }
                            }
            ...
            function dibujarTabla(idTarjeta) {
                ...
                $.ajax({
                    type: "POST",
                    url: "MantSimEfectivoExpress.aspx/Obtener_SIM_EfectivoExpress",
                    data: dataVal,
            ...
            function GuardarSimulador() {
                ...
                $.ajax({
                    type: "POST",
                    url: "MantSimEfectivoExpress.aspx/Guardar_SIM_EfectivoExpress",
                    data: dataVal,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    error: function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        <div style="margin-left: 10px; padding: 10px;">
            ...
            <tr>
                    <td colspan="2">
                        <h3>Simulador Efectivo Express</h3>
                    </td>
                </tr>
                <tr>
                    <td>
