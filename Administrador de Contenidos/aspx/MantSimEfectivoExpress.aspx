    ...
    <body topmargin="0" leftmargin="0" rightmargin="0" marginwidth="0" marginheight="0">
        ...
        <script type="text/javascript">
            ...
            function CrearTabla(tabla) {
                ...
                var cm = [
            { name: 'IDDEFE', index: 'IDDEFE', width: 12, align: 'center', hidden: true },
            { name: 'IDPEFE', index: 'IDPEFE', width: 3, align: 'center', hidden: true },
            { name: 'TIPO_TARJETA', index: 'TIPO_TARJETA', width: 3, align: 'center', hidden: true },
            { name: 'PRODUCTO', index: 'PRODUCTO', width: 180, align: 'center', editable: true },
