...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label6" runat="server" 
            Font-Names="courier new,courier,monospace" Font-Size="X-Large" Font-Bold="True"></asp:Label>
                       </td>
           </tr>
    <tr>
    ...
    <BR>
        <asp:GridView ID="GridView1" runat="server" Font-Names="text-align: center; courier: ; font-family: 'courier new', courier, monospace; font-size: small;" 
    ...
    <td>
        ...
        <asp:GridView ID="GridView2" runat="server" Font-Names="Courier New, Courier, monospace" 
            Font-Size="Small">
        </asp:GridView>
        </td>
    <td></td>
    ...
    <td></td>
    <td>
        <asp:GridView ID="GridView3" runat="server" Font-Names="Courier New, Courier, monospace" 
            Font-Size="Small">
        </asp:GridView>
        </td>
    <td></td>
    ...
    <td></td>
    <td>
        <asp:GridView ID="GridView4" runat="server" Font-Names="Courier New, Courier, monospace" 
            Font-Size="Small">
        </asp:GridView>
        </td>
    <td></td>
    ...
    <td></td>
    <td>
        <asp:GridView ID="GridView5" runat="server" Font-Names="Courier New, Courier, monospace" 
            Font-Size="Small">
        </asp:GridView><Br />
        </td>
    <td></td>
    ...
    <asp:Label ID="Label5" runat="server" 
            Font-Names="courier new,courier,monospace" Font-Size="Small"></asp:Label>
            <BR>
        <asp:GridView ID="GridView6" runat="server" Font-Names="Courier New, Courier, monospace" 
            Font-Size="Small">
        </asp:GridView><Br />
        </td>
    <td></td>
    ...
    <td></td>
    <td>
        <asp:GridView ID="GridView7" runat="server" Font-Names="Courier New, Courier, monospace" 
            Font-Size="Small">
        </asp:GridView><Br />
        </td>
    <td></td>
    ...
    <td></td>
    <td>
        <asp:GridView ID="GridView8" runat="server" Font-Names="Courier New, Courier, monospace" 
            Font-Size="Small">
        </asp:GridView><Br />
        </td>
    <td></td>
    ...
    <td></td>
    <td>
        <asp:GridView ID="GridView9" runat="server" Font-Names="Courier New, Courier, monospace" 
            Font-Size="Small">
        </asp:GridView><Br />
        </td>
    <td></td>
    ...
    <td></td>
    <td>
        <asp:GridView ID="GridView10" runat="server" Font-Names="Courier New, Courier, monospace" 
            Font-Size="Small">
        </asp:GridView><Br /></td>
    <td></td>
    </tr>
